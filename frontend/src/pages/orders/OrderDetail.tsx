                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        {getYearFromDate(order.vehicule.year)}
                      </div>
                      <div className="flex items-center gap-2 text-gray-600">
                        <Gauge className="w-4 h-4" />
                        {order.vehicule.mileage.toLocaleString('fr-FR')} km
                      </div>
                      <div className="flex items-center gap-2 text-gray-600">
                        <Fuel className="w-4 h-4" />
                        {order.vehicule.fuelType}
                      </div>
                    </div>
                    <Link
                      to={`/vehicules/${order.vehicule.id}`}
                ...
                <dl className="space-y-3">
                  ...
                  {order.notes && (
                    <div className="pt-3 border-t border-gray-100">
                      <dt className="text-gray-600 mb-2">Notes</dt>
              ...
              <Card variant="elevated">
                ...
                <div className="space-y-3 pb-4 border-b border-gray-100">
                  <div className="flex justify-between text-gray-600">
                    ...
                    <span>{formatPrice(order.vehicule.salePrice)} €</span>
                  </div>
                </div>
